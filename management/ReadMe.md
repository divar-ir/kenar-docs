...
## تبدیل اَپ تستی به اَپ پروداکشن

**اپ تستی من آماده شده، چه‌طور می‌تونم اون‌ رو روی پروداکشن فعال کنم؟**


زمانی که از عملکرد صحیح تمام بخش‌های اپ تستی‌تان بر روی آگهی‌های تستی (از نظر [فنی](https://github.com/divar-ir/kenar-docs/) و همچنین [سیاست‌های کنار دیوار](https://github.com/divar-ir/kenar-docs/blob/master/policies.md)) مطمئن شدید، از داخل پنل کنار، تیکتی با محتوای درخواست بررسی برنامه ثبت کنید. در صورتی که در سرویس شما نیاز به پرداخت وجه است، لطفاً چند کد تخفیف به همراه تیکت ارسال کنید و یا حساب کاربری شماره ۰۹۳۰۶۶۰۳۳۷۱ را شارژ نموده و یا درگاه پرداخت را برای این حساب غیرفعال کنید. تیکت‌های شما حداکثر تا یک روز کاری بعد از زمان ثبت، پاسخ داده خواهند شد و نتیجه‌ی بررسی اپ، حداکثر تا یک هفته‌ی کاری پس از زمان ثبت درخواست، برای شما از طریق تیکت و در پاسخ به تیکت درخواست بررسی ارسال می‌گردد

در صورتی که اپ دارای مشکلات فنی، پیاده‌سازی و یا نقض قوانین و سیاست‌های کنار دیوار باشد، تک‌تک موارد در نتیجه‌ی بررسی اپ به شما گزارش می‌شود و شما باید تمامی موارد ذکرشده را پیش از ارسال درخواست بررسی مجدد، اصلاح و رفع کنی
  
*در صورتی که مشکلات و یا ایرادات تکراری در فرآیند بررسی مجدد وجود داشته باشد، فرآیند بررسی دفعه‌ی سوم، حداقل یک ماه پس از ثبت درخواست بررسی مجدد انجام خواهد*
  
پس از گذشتن از این مرحله، اپ شما آماده‌ی فعال‌شدن و نمایش به کاربران دیوار است. در این مرحله باید اطلاعاتی را برای ما ارسال کنید. این اطلاعات شامل موارد زیر هستند:
...
ما برای شما یک برنامهٔ آمادهٔ انتشار می‌سازیم و شما می‌توانید این برنامه را در داخل پنل کاربری و قسمت «[برنامه‌ها](https://divar.ir/kenar/management/apps)» مشاهده کنید. از آن‌جایی که شناسه‌ی یکتا (اسلاگ) در این اپ تغییر کرده است، باید برای این اپ کلید اِی‌پی‌آی بسازید و اپ اسلاگ را در هدر اوآث آپدیت کنید
