...
۲. روی دکمهٔ «کلیدهای API» کلید کنید.\
۳. روی دکمهٔ «ساخت کلید جدید» کلیک کنید.\
۴. عنوانی برای کلید جدید خود انتخاب کنید و کلید خود را بسازید.\
۵. مقدار کلیدی که به شما داده می‌شود را ذخیره کنید و در جایی نگه‌داری کنید.\
<br>
