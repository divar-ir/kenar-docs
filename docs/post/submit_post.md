...
سیستم‌های staging به صورت کامل فعال و در دسترس هستند. برای دسترسی به محیط production، لطفاً تیکت ایجاد کنید و موارد استفاده (use case) خود را برای بررسی و تأیید ارسال نمایید.
...
1. **تصاویر را آپلود می‌کنید** - ابتدا تصاویر آگهی خود را به سرویس تصویر دیوار ارسال کرده و شناسه آن‌ها را دریافت می‌کنید
2. **قالب دسته‌بندی را دریافت می‌کنید** - هر دسته‌بندی (مثل املاک، خودرو، موبایل) فیلدهای اختصاصی خود را دارد که باید پر شوند
3. **آگهی را ثبت می‌کنید** - با ارسال اطلاعات عمومی و فیلدهای اختصاصی، یک آگهی در انتظار پرداخت ایجاد می‌شود
4. **هزینه انتشار را پرداخت می‌کنید** - برای انتشار آگهی، باید هزینه آن را از اعتبار اپلیکیشن خود پرداخت کنید
5. **آگهی بررسی و منتشر می‌شود** - پس از پرداخت، آگهی وارد صف بررسی شده و پس از تأیید در دیوار منتشر می‌شود
...
### 1. ثبت آگهی به عنوان ارائه‌دهنده (Provider)
...
### 2. ثبت آگهی به عنوان کاربر (User)
...
**دسترسی مورد نیاز:** OAuth scope `SUBMIT_USER_POST`
...
### مرحله 2: ثبت آگهی (ایجاد آگهی در انتظار پرداخت)
...
### مرحله 3: دریافت قیمت انتشار (اختیاری)
...
**دسترسی مورد نیاز:** OAuth scope `POST_EDIT.{post_token}`
