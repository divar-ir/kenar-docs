...
3.  **فیلد‌های مربوط به کسب‌وکار**:  این مجموعه از فیلدها تنها در صورتی در داده‌های آگهی موجود خواهند بود که آگهی توسط یک **کاربر کسب‌وکار** (مانند آژانس املاک، فروشگاه رسمی، نمایشگاه خودرو، شرکت خدماتی و غیره) ثبت شده باشد. هدف از این فیلدها، ارائه اطلاعات تکمیلی در مورد هویت تجاری آگهی‌دهنده است. دو فیلد اصلی و مهم که مورد استفاده قرار می‌گیرند، عبارتند از:
    *   **نام کسب‌وکار (Business Name)**
    *   **نوع کسب‌وکار (Business Type)**
