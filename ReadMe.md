...
| /conversations/{{conversation-id}}/messages |  POST  | ارسال پیام در یک چت                                                  |   CHAT_SEND_MESSAGE_OAUTH    | CONVERSATION_SEND_MESSAGE | [ارسال پیام در چت][راهنما » افزونه‌های چت » ارسال پیام]   |
| /events/subscriptions                       |  POST  | ایجاد هوک مطلع شدن از رویدادها                                       | EVENTS_REGISTER_SUBSCRIPTION |             -             | [راهنما » رویدادها][رویداد‌ها]                            |
