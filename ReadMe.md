...
۵. این [فهرست درخواست‌ها][postman_collection] را دانلود کنید و در ابزارهایی مثل Postman وارد کنید و شروع کنید.
...
برنامه‌های متصل به کنار دیوار با هر زبانی می‌توانند توسعه یابند، اما برقراری ارتباطشان با کنار دیوار از طریق [درخواست‌های HTTP](#تعامل-با-سرویس‌های-دیوار) خواهد‌بود.
