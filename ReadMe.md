...
> 🚧 ***در دست احداث*** 🚧
>
> **کنار دیوار**‌ در حال حاضر در مرحلهٔ آزمایشی است و امکان ثبت‌نام عمومی وجود ندارد. برای ثبت‌نام و ارائهٔ خدمات در این بستر، [در لیست انتظار ثبت‌نام کنید][فرم ثبت‌نام]. در این مرحله ممکن است قواعد، سیاست‌ها و ابزارهای **کنار دیوار** دچار تغییرات ناگهانی شوند. به دلیل سرعت تغییرات، ممکن است در بازه‌های زمانی خاصی اطلاعات ارائه شده در این مخزن نیز ناقص یا نیازمند بروزرسانی باشند.

<br>

# نمای کلی

خدمات مختلف در **کنار دیوار** در قالب «برنامه‌» یا «اپلیکیشن» (Application) ها به کاربران ارائه می‌شوند. کاربران در نقاط مشخصی از دیوار مثل [صفحهٔ آگهی](#خدمات-روی-آگهی‌ها-📜) یا [چت](#خدمات-در-چت-💬)، می‌توانند به درخواست خودشان با برنامهٔ شما در قالب یک برنامهٔ وب تعامل کنند، در صورت نیاز اجازه‌های لازم را به شما بدهند، خدمات مورد نظر را دریافت کنند و به دیوار برگردند.

در مرحلهٔ آزمایشی، برای تعریف برنامهٔ جدید [با ما تماس بگیرید][تلگرام کنار].\
...
۳. در صورت نیاز می‌توانید در وب‌اپ خود  [اطلاعات آگهی][راهنما » اطلاعات آگهی] یا [اطلاعات کاربر][راهنما » اطلاعات کاربر] را (با [کسب اجازهٔ کاربر][راهنما » احراز باز]) از دیوار دریافت کنید.\
...
۱. برنامه‌های مرتبط با آگهی و مکالمهٔ کاربران به آنها پیشنهاد داده‌می‌شود.\
...
۴. به علاوه، در این مرحله می‌توانید [با اجازهٔ کاربر][راهنما » احراز باز]، در مکالمه‌ [پیام ارسال کنید][راهنما » افزونه‌های چت » ارسال پیام]. \
