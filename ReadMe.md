...
### ایجاد چت‌بات
به منظور ایجاد و فعالسازی چت بات می‌توانید به پشتیبانی کنار دیوار تیکت بزنید و درخواست تون رو مطرح کنید تا زیرساخت آن در دسترس‌تون قرار بگیره.

در صورت برخوردار شدن از این امکان توسط پشتیبانی با پرکردن مقدار `آدرس ارسال رویدادها` در پنل کنار پیام های ارسالی به چت‌بات تون رو دریافت خواهید کرد برای اطلاعات بیشتر و فرمت درخواست های ارسالی میتونید [اینجا][راهنما » چت‌بات » دریافت‌پیام‌ها] رو بخونید.

همچنین میتونید به کاربر هایی که به چت‌بات تون پیام دادن پیام بفرستید برای اطلاعات بیشتر [اینجا][راهنما » چت‌بات » ارسال‌پیام] رو مطالعه کنید.
<br>
مثال چت: پیاده‌سازی
[بازی ایکس او](https://github.com/amirsalarsafaei/kenar-xo/tree/master)
با کنار دیوار
