...
> 🚧 ***APIهای آزمایشی*** 🚧
>
> برخی از APIهای **کنار دیوار** در حال حاضر در مرحلهٔ آزمایشی هستند. در این مرحله ممکن است قواعد، سیاست‌ها و ابزارهای آزمایشی در بازه‌های زمانی کوتاه تغییر کنند. به دلیل سرعت تغییرات، ممکن است در بازه‌های زمانی خاصی اطلاعات ارائه شده در مورد این APIها در این مخزن نیز ناقص یا نیازمند بروزرسانی باشند. آدرس APIهای آزمایشی در مستندات به جای نسخه‌بندی (مثلاً v2) با experimental شروع می‌شود.
