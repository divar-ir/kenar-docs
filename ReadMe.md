...
خدمات مختلف در **کنار دیوار** در قالب «برنامه‌» یا «اپلیکیشن» (Application) ها به کاربران ارائه می‌شوند. کاربران در نقاط مشخصی از دیوار مثل [صفحهٔ آگهی](#خدمات-روی-آگهیها-) یا [چت](#خدمات-در-چت-)، می‌توانند به درخواست خودشان با برنامهٔ شما در قالب یک برنامهٔ وب تعامل کنند، در صورت نیاز اجازه‌های لازم را به شما بدهند، خدمات مورد نظر را دریافت کنند و به دیوار برگردند.
