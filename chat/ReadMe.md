...
- برای [دریافت اجازه‌ها][راهنما » احراز باز] یا [استتفاده از امکانات مربوط به چت][امکانات چت]، هر سهٔ این پارامترها را ارائه کنید.
...
- [↗️ ارسال پیام در یک چت][چت»ارسال پیام]
- [✉️ دریافت پیام‌های یک چت](read_post_conversations.md)
- [📨 دریافت پیام‌های چت‌های یک ‌آگهی](read_post_conversations.md)
